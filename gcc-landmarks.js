...
(function(){
  ...
  const GH_LANDMARKS = {
    ...
    "B2-47"   : { name: "Johnsport", kind: "city", isPort: true },
    "B2-56"   : { name: "Eastfair", kind: "city" },
    "B2-99"   : { name: "Ducchan", kind: "city", isPort: true },
    "B3-38"   : { name: "Bastro", kind: "city", isPort: true },
    "B3-75"   : { name: "Rel Mord", kind: "city", region: "Kingdom of Nyrond", isPort: true },
    "B5-90"   : { name: "Highfolk", kind: "city", isPort: true },
    "B5-95"   : { name: "Mitrik", kind: "city", region: "Archclericy of Veluna", isPort: true },
    "C-17"    : { name: "Glot", kind: "city", isPort: true },
    "C2-27"   : { name: "Krakenheim", kind: "city", isPort: true },
    "C3-42"   : { name: "Vlekstaad", kind: "city", isPort: true },
    "C4-78"   : { name: "Critwall", kind: "city", region: "Shield Lands", isPort: true },
    "C4-91"   : { name: "Hardby", kind: "town", size: "small-city", pop: 7500, region: "Domain of Greyhawk", isPort: true },
    "C5-77"   : { name: "Traft", kind: "city", isPort: true },
    "D-55"    : { name: "Oakenhart", kind: "city", isPort: true },
    "D-79"    : { name: "Lo Reltarma", kind: "city" },
    "D2-78"   : { name: "Torrich", kind: "city" },
    "D2-93"   : { name: "Dullstrand", kind: "city", isPort: true },
    ...
    "E4-73"   : { name: "Molag", kind: "city", region: "Horned Society", isPort: true },
    "E4-82"   : { name: "Willip", kind: "city", region: "Kingdom of Furyondy", isPort: true },
    "E5-82"   : { name: "Schwartzenbruin", kind: "city", isPort: true },
    "F2-83"   : { name: "Nulbish", kind: "city", isPort: true },
    "F4-101"  : { name: "Elredd", kind: "city", isPort: true },
    "F4-94"   : { name: "Safeton", kind: "town", region: "Wild Coast", isPort: true },
    "F5-105"  : { name: "Hookhill", kind: "city" },
    "G-22"    : { name: "Soill", kind: "city", isPort: true },
    "G-54"    : { name: "Asperdi", kind: "city", isPort: true },
    "H2-47"   : { name: "Ratikhill", kind: "city" },
    "H4-89"   : { name: "Dyvers", kind: "city", size: "city", pop: 42000, region: "Wild Coast", isPort: true },
    "H4-99"   : { name: "Fax", kind: "city", isPort: true },
    "H6-95"   : { name: "Ekbir", kind: "city" },
    "I2-44"   : { name: "Marner", kind: "city", isPort: true },
    "I2-51"   : { name: "Spinecastle", kind: "city" },
    "I3-64"   : { name: "Stoink", kind: "city" },
    "I4-102"  : { name: "Badwall", kind: "city" },
    "I4-68"   : { name: "Dorakaa", kind: "city", region: "Empire of Iuz", isPort: true },
    "I4-94"   : { name: "Narwell", kind: "town", region: "Wild Coast" },
    "I5-100"  : { name: "Thornward", kind: "city" },
    "J2-37"   : { name: "Djekul", kind: "city" },
    "J3-74"   : { name: "Trigol", kind: "city", isPort: true },
    "J4-76"   : { name: "Grabford", kind: "city", isPort: true },
    "J5-120"  : { name: "Flen", kind: "city" },
    "J6-163"  : { name: "Forgotten City", kind: "city" },
    "K-54"    : { name: "Winetha", kind: "city", isPort: true },
    "K4-111"  : { name: "Havenhill", kind: "city" },
    "L2-90"   : { name: "Pitchfield", kind: "city" },
    "L4-113"  : { name: "Gryrax", kind: "city", isPort: true },
    "L6-101"  : { name: "Zeif", kind: "city", isPort: true },
    "M4-95"   : { name: "Nulb", kind: "village" },
    "M5-114"  : { name: "Orlane", kind: "city" },
    "M5-130"  : { name: "Loftwick", kind: "city" },
    "M5-93"   : { name: "Molvar", kind: "city" },
    "N-11"    : { name: "Jotsplat", kind: "city", isPort: true },
    "N-18"    : { name: "Knudje", kind: "city" },
    "N-52"    : { name: "Rinloru", kind: "city" },
    "N-59"    : { name: "Roland", kind: "city" },
    "N3-100"  : { name: "Scant", kind: "city", isPort: true },
    "N3-58"   : { name: "Rookroost", kind: "city" },
    "N4-104"  : { name: "Courwood", kind: "city", isPort: true },
    "N4-96"   : { name: "Hommlet", kind: "village" },
    "N5-114"  : { name: "Hochoch", kind: "city", region: "Gran March" },
    "N5-82"   : { name: "Exag", kind: "city" },
    "O-48"    : { name: "Atirr", kind: "city", isPort: true },
    "O5-123"  : { name: "Istivin", kind: "city" },
    "P-70"    : { name: "Rel Astra", kind: "city", region: "Great Kingdom", isPort: true },
    "P4-100"  : { name: "Enstad", kind: "city", region: "Celene", isPort: true },
    "P4-89"   : { name: "Littleberg", kind: "city", region: "Kingdom of Furyondy", isPort: true },
    "P4-95"   : { name: "Verbobonc", kind: "city", region: "Viscounty of Verbobonc", isPort: true },
    "Q3-73"   : { name: "Radigast City", kind: "city", region: "County of Urnst", isPort: true },
    "Q4-117"  : { name: "Gradsul", kind: "city", region: "Kingdom of Keoland", isPort: true },
    "Q4-55"   : { name: "Dandredun", kind: "city" },
    "Q4-81"   : { name: "Crockport", kind: "city", isPort: true },
    "Q4-83"   : { name: "Chendl", kind: "city", region: "Kingdom of Furyondy", isPort: true },
    "R2-33"   : { name: "Kelten", kind: "city" },
    "R2-88"   : { name: "Hexpools", kind: "city", isPort: true },
    "R3-80"   : { name: "Leukish", kind: "city", region: "Duchy of Urnst", isPort: true },
    "R4-112"  : { name: "Jurnre", kind: "city", region: "County of Ulek", isPort: true },
    "R5-120"  : { name: "Gorna", kind: "city" },
    "S-77"    : { name: "Mentrey", kind: "city" },
    "S2-79"   : { name: "Chathold", kind: "city", isPort: true },
    "S4-107"  : { name: "Tringlee", kind: "city" },
    "S5-98"   : { name: "Lopolla", kind: "city", isPort: true },
    "T4-125"  : { name: "Monmurg", kind: "city", isPort: true },
    "U-90"    : { name: "Sulward", kind: "city", isPort: true },
    "U2-85"   : { name: "Prymp", kind: "city", isPort: true },
    "U3-103"  : { name: "Blue", kind: "city", isPort: true },
    "U4-64"   : { name: "Eru-Tovar", kind: "city", isPort: true },
    "V-48"    : { name: "Kaport Bay", kind: "city", isPort: true },
    "V-59"    : { name: "Delarie", kind: "city", isPort: true },
    "V2-112"  : { name: "Kro Terlep", kind: "city", isPort: true },
    "V2-99"   : { name: "Naerie", kind: "city", isPort: true },
    "V4-130"  : { name: "Port Toli", kind: "city", isPort: true },
    "W2-40"   : { name: "Purmill", kind: "city", isPort: true },
    ...
    "Y-68"    : { name: "Rauxes", kind: "city", region: "Great Kingdom", isPort: true },
    "Y2-77"   : { name: "Mithat", kind: "city", isPort: true },
    ...
    "Z-82"    : { name: "Pontylver", kind: "city", isPort: true },
    "Z2-80"   : { name: "Oldred", kind: "city", isPort: true },
    "Z5-100"  : { name: "Ceshra", kind: "city", isPort: true },
    "Z5-98"   : { name: "Sefmur", kind: "city", isPort: true },
  };
