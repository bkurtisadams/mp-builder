    ...
    const camps = [
      {
        ...
        notes: '',
        characters: [
          { name: 'Crosswise', sub: 'F-GD-EX-GD-TY' },
          { name: 'Psyren', sub: 'TY-GD-EX-RM-EX' },
          { name: 'Bulwark', sub: 'IN-RM-GD-TY-GD' },
          { name: 'Flashpoint', sub: 'GD-EX-RM-GD-TY' },
        ],
        sessions: [
      ...
      },
      {
        ...
        notes: '',
        characters: [
          { name: 'Aldric of Verbobonc', sub: 'Ftr 9' },
          { name: 'Mirenna', sub: 'M-U 7' },
          { name: 'Brother Osric', sub: 'Clr 8' },
          { name: 'Kellan Swiftblade', sub: 'Thf 8' },
          { name: 'Elyn Dawnwood', sub: 'Rgr 7' },
          { name: 'Grumthar', sub: 'Ftr 6 / Thf 5' },
        ],
        sessions: [
      ...
      },
      {
        ...
        notes: '',
        characters: [
          { name: 'Dain Ironforge', sub: 'Ftr 5' },
          { name: 'Seraphina', sub: 'Pr 6' },
          { name: 'Thorn', sub: 'Thf 4' },
        ],
        sessions: [
